...
Для того, чтобы удалить ветку необходимо использовать команду *git branch -d <наименование ветки>*, **не рекомендуется** использовать команду *git branch -D <наименование ветки>* так как она удаляет без слияния ветки.
